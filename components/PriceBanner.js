											...
											<div className='price-box_list'>
												<ul>
													<li>
														...
														Hatchback - <span className='price-span'>1800</span>
													</li>
													<li>
														<i className='fa-solid fa-check'></i>
														Sedan -{' '}
													...
													<li>
														<i className='fa-solid fa-check'></i>
														Compact SUV -{' '}
														<span className='price-span'>2200</span>{' '}
													</li>
													<li>
														<i className='fa-solid fa-check'></i>
														Full Size-SUV -{' '}
														<span className='price-span'>2600 </span>{' '}
													</li>
													<li>
														<i className='fa-solid fa-check'></i>
														Luxury -
										...
										<div className='price-box_content'>
											...
											<div className='price-box_list'>
												<ul>
													<li>
														<i className='fa-solid fa-check'></i>
														Hatchback - <span className='price-span'>1000</span>
													</li>
													<li>
														<i className='fa-solid fa-check'></i>
														Sedan -{' '}
													...
													<li>
														<i className='fa-solid fa-check'></i>
														Compact SUV -{' '}
														<span className='price-span'>1400</span>{' '}
													</li>
													<li>
														<i className='fa-solid fa-check'></i>
														Full Size-SUV -{' '}
														<span className='price-span'>1600 </span>{' '}
													</li>
													<li>
														<i className='fa-solid fa-check'></i>
														Luxury -
										...
										<div className='price-box_content'>
											...
											<div className='price-box_list'>
												<ul>
													<li>
														<i className='fa-solid fa-check'></i>
														Hatchback - <span className='price-span'>1200</span>
													</li>
													<li>
														<i className='fa-solid fa-check'></i>
														Sedan -{' '}
